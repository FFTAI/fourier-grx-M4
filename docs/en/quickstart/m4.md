...
> ⚠️ **Deprecated**
>
> This page describes the workflow for the legacy `fourier-m4` software, which is no longer actively maintained.
> If your device supports the new software, please refer to the [M4L Robot](/fourier-grx-M4/docs/en/quickstart/m4l) Quick Start documentation.
...
The following video tutorial demonstrates how to quickly get started with the M4 series robot.
