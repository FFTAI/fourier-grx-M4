...
提供了一套 API 用于安装、配置、控制傅利叶智能的 M4 或 M4L 机器人产品的应用程序。
...
[常用操作](/fourier-grx-M4/docs/usage) 包含了一些常用操作的说明，包括机器人校准方法，以及操作模式的切换等。固件安装方法请参考 [快速开始 - 固件安装（首次安装）](/fourier-grx-M4/docs/quickstart/firmware_install)，固件升级方法请参考 [快速开始 - 固件更新](/fourier-grx-M4/docs/quickstart/firmware_update)。
...
> - User 接口通过网络与机器人通信，无明确平台和语言限制，但仍推荐在 Ubuntu 系统上进行开发。
> - Developer 接口基于 Python 库开发。

## 更新日志

请查看 [更新日志](/fourier-grx-M4/docs/changelog) 以获取最新版本文档的更新内容。
